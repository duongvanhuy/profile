...
//ddieeuf kieenj khi chauw nhaapj duwx lieeuj
        donhang.setLoaiThanhToan(txtHTThanhToan.getSelectedIndex()+1);
        donhang.setSoLuong(Integer.valueOf(txtSoLuong.getText()));
        donhang.setDiaChiGH(txtDiaChi.getText());
        donhang.setKhachHang(txtKhachHang.getText());
        donhang.setHinhThucVC(txtHTVanChuyen.getSelectedIndex()+1);
        donhang.setPhiVC(Integer.valueOf(txtPhiVC.getText()));
        donhang.setNgayDat(Date.from(ngayGio.atStartOfDay().atZone(ZoneId.systemDefault()).toInstant()));
        
        String sdt = txtSDT.getText();
        String maMH = txtMaSP.getText();
//       thêm vào bảng đon hàng
    ...
    private void btnQuayLaiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnQuayLaiActionPerformed
        // TODO add your handling code here:
//        List<MatHang> sanpham = 
        String[] listmaMH = sanphamDAO.getAllMaMH();
//        sinh ra mã MH ngẫu nhiên
        int a =  usingThreadLocalClass(listmaMH.length);
       txtMaSP.setText(listmaMH[a]);
       
//       sinh ra số lượng ngấu xnhieen
       Random rand = new Random();
        int ranNum = rand.nextInt(5)+1;
        txtSoLuong.setText(String.valueOf(ranNum));
        
//        sinh ra tên ngẫu nhiên
txtKhachHang.setText(getTenKH());
//          sinh ra số điện thoại ngẫu nhiên;
txtSDT.setText(getSDT());
// sinh ra dia chi
txtDiaChi.setText(getDiaChi());

txtHTThanhToan.setSelectedIndex(0);
txtHTVanChuyen.setSelectedIndex(1);
txtPhiVC.setText("30000");
